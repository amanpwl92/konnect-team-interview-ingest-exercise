...
public class Service extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7331770269825180030L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Service\",\"namespace\":\"org.konnect.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"}]}");
   ...
   */
  public Service(java.lang.CharSequence id) {
    this.id = id;
  }
   ...
   */
  public static org.konnect.avro.Service.Builder newBuilder() {
    return new org.konnect.avro.Service.Builder();
  }
   ...
   * @return A new Service RecordBuilder
   */
  public static org.konnect.avro.Service.Builder newBuilder(org.konnect.avro.Service.Builder other) {
    if (other == null) {
      return new org.konnect.avro.Service.Builder();
    } else {
      return new org.konnect.avro.Service.Builder(other);
    }
  }
   ...
   * @return A new Service RecordBuilder
   */
  public static org.konnect.avro.Service.Builder newBuilder(org.konnect.avro.Service other) {
    if (other == null) {
      return new org.konnect.avro.Service.Builder();
    } else {
      return new org.konnect.avro.Service.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Service>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.konnect.avro.Service.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.konnect.avro.Service other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.konnect.avro.Service.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.konnect.avro.Service.Builder clearId() {
      id = null;
